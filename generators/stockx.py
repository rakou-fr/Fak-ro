...
async def generate(fields, is_free):
    ...
    f1 = ImageFont.truetype("calibri-font-family/MYRIADPRO-BOLD.OTF", 33)
    f2 = ImageFont.truetype("calibri-font-family/MYRIADPRO-BOLD.OTF", 30)
    f3 = ImageFont.truetype("calibri-font-family/MYRIADPRO-BOLD.OTF", 41)
    f4 = ImageFont.truetype("calibri-font-family/MYRIADPRO-BOLD.OTF", 60)
    f5 = ImageFont.truetype("calibri-font-family/MYRIADPRO-BOLD.OTF", 36)

    # Layer 1: field
    _txt0 = date
    t(draw, (775, 167), _txt0, f1, (255, 255, 255), 4)

    # Layer 2: random_address
    _txt1 = adresse()
    t(draw, (47, 406), _txt1, f2, (0, 0, 0), 4)

    # Layer 3: random_text
    _txt2 = f"{random.randint(10000000, 99999999)}-{random.randint(10000000, 99999999)}"
    t(draw, (576, 445), _txt2, f3, (0, 0, 0), 4)

    # Layer 4: field
    _txt3 = wrap(desc, 28)
    t(draw, (48, 586), _txt3, f4, (0, 0, 0), 4)

    # Layer 5: formula
    _txt4 = f"{taille}\n{couleur}\n{style}\nNew; 100% authentic"
    t_left(draw, (962, 762), _txt4, f5, (0, 0, 0), 22)

    # Layer 6: formula
    subtotal = float(prix) - 7.39 - 13.50
    _txt5 = f"${subtotal:.2f}\n$7.39\n$15.50\n{prix:.2f}"
    t_left(draw, (962, 1128), _txt5, f5, (0, 0, 0), 22)
