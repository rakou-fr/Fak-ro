...
async def generate(fields, is_free):
    ...
    f1 = ImageFont.truetype("calibri-font-family/Calibri-bold.ttf", 15)
    f2 = ImageFont.truetype("calibri-font-family/Calibri-Bold.ttf", 14)

    # Layer 1: field
    _txt0 = qte
    t(draw, (W // 2 + int(200 * 1), int(340 * 1)), _txt0, f1, (80, 80, 80), 4)

    # Layer 2: field
    _txt1 = sku
    t(draw, (W // 2 + int(-305 * 1), int(340 * 1)), _txt1, f1, (80, 80, 80), 4)

    # Layer 3: field
    _txt2 = wrap(item_name, 14)
    t(draw, (W // 2 + int(-70 * 1), int(340 * 1)), _txt2, f1, (80, 80, 80), 4)

    # Layer 4: random_address
    _txt3 = adresse()
    t(draw, (W // 2 + int(-315 * 1), int(190 * 1)), _txt3, f2, (80, 80, 80), 4)

    # Layer 5: random_text
    _txt4 = f"0{random.randint(1, 9)}/0{random.randint(1, 9)}/{random.randint(2021, 2023)}"
    t(draw, (W // 2 + int(70 * 1), int(187 * 1)), _txt4, f2, (80, 80, 80), 4)

    # Layer 6: random_text
    _txt5 = f"#{random.randint(100000, 999999)}"
    t(draw, (W // 2 + int(190 * 1), int(221 * 1)), _txt5, f2, (80, 80, 80), 4)

    # Layer 7: random_text
    _txt6 = f"{random.randint(1000000000, 9999999999)}"
    t(draw, (W // 2 + int(124 * 1), int(237 * 1)), _txt6, f2, (80, 80, 80), 4)
